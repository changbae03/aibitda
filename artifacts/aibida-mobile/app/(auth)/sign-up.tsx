...
const s = StyleSheet.create({
  ...
  title: { fontSize: 24, fontFamily: "Pretendard-Bold", color: "#0d1421", marginBottom: 8 },
  subtitle: { fontSize: 16, color: "#5d6678", fontFamily: "Pretendard-Regular", marginBottom: 24, lineHeight: 22 },
  googleBtn: {
