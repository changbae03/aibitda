      ...
      <KeyboardAvoidingView style={s.flex} behavior={Platform.OS === "ios" ? "padding" : undefined}>
        <ScrollView contentContainerStyle={[s.container, { paddingTop: insets.top + 20, paddingBottom: insets.bottom + 40 }]}>
          ...
          <View style={s.verifyIcon}>
            <Feather name="mail" size={32} color="#f97316" />
          </View>
...
const s = StyleSheet.create({
  ...
  appTagline: { fontSize: 13, color: "#5d6678", fontFamily: "Inter_400Regular" },
  verifyIcon: {
  ...
  title: { fontSize: 22, fontFamily: "Inter_700Bold", color: "#0d1421", marginBottom: 8 },
  subtitle: { fontSize: 14, color: "#5d6678", fontFamily: "Inter_400Regular", marginBottom: 24, lineHeight: 22 },
  googleBtn: {
  ...
  googleText: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: "#0d1421" },
  dividerRow: { flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 16 },
  dividerLine: { flex: 1, height: 1, backgroundColor: "#dde0ea" },
  dividerText: { fontSize: 12, color: "#9aa3b2", fontFamily: "Inter_400Regular" },
  label: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: "#5d6678", marginBottom: 6 },
  input: {
    backgroundColor: "#fff", borderRadius: 12, paddingHorizontal: 14, paddingVertical: 13,
    fontSize: 15, fontFamily: "Inter_400Regular", color: "#0d1421",
