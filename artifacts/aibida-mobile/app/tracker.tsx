                  ...
                  <View style={{ alignItems: "flex-end", gap: 4 }}>
                    {currentPrice != null ? (
                      <>
                        ...
                        {q?.change != null && (
                          <Text style={{ fontSize: 12, fontFamily: "Inter_600SemiBold", color: q.change >= 0 ? colors.up : colors.down }}>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                  {upside != null && (
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
                      <Text style={{ fontSize: 12, color: colors.mutedForeground, fontFamily: "Inter_400Regular" }}>남은 상승여력</Text>
                      <Text style={{ fontSize: 14, fontFamily: "Inter_700Bold", color: upside >= 0 ? colors.up : colors.down }}>
...
function makeStyles(c: ReturnType<typeof useColors>) {
  return StyleSheet.create({
    ...
    currentPrice: { fontSize: 16, fontFamily: "Inter_700Bold", color: c.foreground },
    verdictBadge: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 6 },
    verdictText: { fontSize: 11, fontFamily: "Inter_600SemiBold" },
    empty: { flex: 1, alignItems: "center", justifyContent: "center", gap: 12, paddingHorizontal: 40 },
    emptyTitle: { fontSize: 16, fontFamily: "Inter_600SemiBold", color: c.foreground },
    emptyDesc: { fontSize: 13, color: c.mutedForeground, textAlign: "center", fontFamily: "Inter_400Regular", lineHeight: 20 },
  });
}
