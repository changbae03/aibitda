...
function MarketFlowChart({ rows }: { rows: MarketRow[] }) {
  if (!rows.length) return (
    <div className="py-8 text-center text-[13px] text-muted-foreground/30">데이터 없음</div>
  );
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        rank === 1 ? "bg-amber-100 text-amber-600 dark:bg-amber-900/40 dark:text-amber-400"
          : rank === 2 ? "bg-zinc-100 text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400"
      ...
      <div className="flex-1 min-w-0">
        ...
        {stock.sector && (
          <div className="text-[10px] text-muted-foreground/40 truncate mt-0.5">{stock.sector}</div>
        )}
      </div>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                v > 0 ? "bg-rose-50 dark:bg-rose-950/30"
                  : v < 0 ? "bg-sky-50 dark:bg-sky-950/30"
                  : "bg-muted/20",
              )}
            >
              <span className="text-[9px] text-muted-foreground/50 leading-none mb-0.5">{label}</span>
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className={cn("text-[13px] font-bold", agree ? "text-emerald-700 dark:text-emerald-400" : "text-amber-700 dark:text-amber-400")}>
            {agree
        ...
        <div className="flex items-start justify-between mb-7">
          <div>
            <div className="flex items-center gap-2.5 mb-1">
              ...
              <span className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-[10px] font-semibold text-emerald-600 dark:text-emerald-400">
          ...
          <div className="flex items-center gap-2 pt-0.5">
            ...
            <button
              ...
              className="p-1.5 rounded-lg hover:bg-muted/50 transition-colors text-muted-foreground/40 hover:text-foreground disabled:opacity-30"
            >
        ...
        {loading ? (
          ...
          >
            ...
            <div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      tab === t.key
                        ...
                        : "bg-muted/40 text-muted-foreground/60 hover:bg-muted/70 hover:text-foreground/80",
                    )}
                  >
                    {t.icon}
                    {t.label} 순매수
              ...
              <div className="rounded-2xl border border-border/40 overflow-hidden bg-card">
                {sorted.length === 0 ? (
                  <div className="py-12 text-center text-[13px] text-muted-foreground/30">
                    종목 수급 데이터가 없습니다<br />
            ...
            <p className="text-[10px] text-muted-foreground/25 text-center leading-relaxed pt-2">
