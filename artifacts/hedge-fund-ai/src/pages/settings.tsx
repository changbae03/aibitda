                ...
                <div className="rounded-xl border border-border/60 bg-card overflow-hidden">
                  <div className="px-4 py-3 border-b border-border/60">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-[12px] font-semibold text-foreground">{t("무료 크레딧 적립", "Free Credits")}</p>
                    </div>
                  </div>
                  <div className="divide-y divide-border/40">
                    <div className="flex items-center justify-between px-4 py-3">
                      <span className="text-[12px] text-foreground/80">{t("신규 가입", "Sign up")}</span>
                      <span className="text-[12px] font-semibold text-emerald-500">+10{t("개", " credits")}</span>
                    </div>
                    <div className="flex items-center justify-between px-4 py-3">
                      <div>
                        <p className="text-[12px] text-foreground/80">{t("친구 추천 링크 클릭", "Friend clicks referral link")}</p>
                        <p className="text-[10px] text-muted-foreground/50 mt-0.5">{t("월 최대 10개", "Max 10 / month")}</p>
                      </div>
                      <span className="text-[12px] font-semibold text-emerald-500">+1{t("개", " credit")}</span>
                    </div>
                    <div className="flex items-center justify-between px-4 py-3">
                      <span className="text-[12px] text-foreground/80">{t("크레딧 유효기간", "Credit expiry")}</span>
                      <span className="text-[12px] font-semibold text-foreground/70">{t("6개월", "6 months")}</span>
                    </div>
                  </div>
                </div>
              </>
