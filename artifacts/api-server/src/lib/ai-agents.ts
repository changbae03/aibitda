...
[의무 적용 방법]
① DCF 내재가치 산출 후: 코리아 디스카운트 15~25% 적용
  - 대형주(코스피 대형주): 15~20% 할인
  - 중소형주(코스닥): 20~30% 할인
  - 예: DCF 내재가치 100만원 → 코스피 대형주 80~85만원, 코스닥 70~80만원
② 글로벌 피어 멀티플 사용 시: 피어 목표가에 20~25% 추가 할인 적용
  - 단, 한국 피어(국내 동종업종) 멀티플을 우선 사용하면 추가 할인 불필요
③ 적용 후 명시 의무: "코리아 디스카운트 __% 적용 → DCF 조정 내재가치: __원" 한 줄 출력

⚠️ 코리아 디스카운트 미적용 시 목표가가 현실 주가 대비 2~3배 과대평가되는 구조적 오류가 발생합니다.
...
═══ 극단값 양방향 가드레일 ═══
⚠️ 목표가 ≥ 현재가 × 2 (upside 100% 이상) → "목표가 극단적 상승 감지" — 즉시 다음 순서로 재검토:
  1. WACC가 성숙 대형주 기준 10% 이상인지 확인
  2. g가 2.0% 이하인지 확인
  3. Terminal Value 비중이 80% 이하인지 확인
  4. 코리아 디스카운트가 반영됐는지 확인
  → 위 4개 항목 점검 후 수정된 목표가 반드시 재산출하고 최종값으로 사용
...
② [한국 주식] 내재가치(코리아 디스카운트 적용 전) > 현재주가 × 2.5 → "⚠️ DCF 과대 산출 의심" 경고 후 WACC·g·S-to-C 재검토
   [미국 주식] 내재가치 > 현재주가 × 3.0 → "⚠️ DCF 과대 산출 의심" 경고 후 재검토
③ 내재가치 < 현재주가 × 0.3 (downside > −70%): "⚠️ DCF 과소 산출 의심 — WACC·순현금 부호·발행주식수 단위 재검토" 경고 후 가정 재점검
④ [한국 주식] 코리아 디스카운트 적용 후 최종 목표가가 현재주가 × 2.0 초과 시: 경고 병기 + 근거(특수 성장 상황) 반드시 명시
- 재점검 후에도 동일 결론이면 수치 유지 가능 — 단 경고와 근거 반드시 병기
- 경고 없이 극단 목표가를 그냥 제시하는 것은 금지
