...
④ 과거 3개년(${new Date().getFullYear()-5}~${new Date().getFullYear()-3}) 데이터가 컨텍스트에 없으면 추정·추측하지 말고 "—" 표시
...
| 지표 | ${new Date().getFullYear()-5} | ${new Date().getFullYear()-4} | ${new Date().getFullYear()-3} | ${new Date().getFullYear()-2} | ${new Date().getFullYear()-1} | TTM | 추세 |
|------|------:|------:|------:|------:|------:|------:|:----:|
| 매출 (단위) | | | | | | | ↑/↓/→ |
| 영업이익 (단위) | | | | | | | ↑/↓/→ |
| 순이익 (단위) | | | | | | | ↑/↓/→ |
