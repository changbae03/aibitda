...
"촉매 분析에서 도출된 핵심 이슈 '[이슈명]'의 재무 영향을 기반으로 실적을 전망합니다."
...
⛔ **이 섹션 작성 금지 사항**:
- 매출·영업이익·EPS의 절대 수치(조원, 억원)를 이 섹션에 다시 나열하지 마세요. 해당 수치는 앞 섹션에 이미 있습니다.
- EPS 수정률(예: "79% 상향", "112% 상향")을 수치로 인용하지 마세요. 이 섹션의 초점은 오직 "주가 상승폭 vs 예상 촉매 주가 영향(%)" 비교입니다.
- 실적 기대감은 방향성("실적 기대감이 빠르게 높아지고 있습니다" 등) 한 문장으로만 서술하세요.
