...
⚠️ D/E: "[⚡ WACC·EBITDA 계산 핵심 데이터]"의 총부채(annualTotalDebt) ÷ 자기자본(annualStockholdersEquity) 우선 계산. 없으면 balanceSheetHistory totalLiab÷totalStockholderEquity. 그것도 없으면 financialData.debtToEquity 사용.
