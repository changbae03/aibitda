...
- 각 시나리오는 반드시 **실현 조건 / 사업 전개 / 주가 시사점** 3개 항목을 각각 별도 불릿으로 작성하세요

각 항목 작성 지침:
- **실현 조건**: 이 시나리오가 현실화되기 위한 구체적 이벤트·조건 (1~2문장)
- **사업 전개**: 조건 충족 시 사업 구도가 어떻게 바뀌는지 — 시장 점유율·고객사 관계·경쟁사 대비 포지셔닝·제품 수요 변화 중심 (2~3문장)
- **주가 시사점**: 투자자 심리·밸류에이션 재평가 방향·섹터 내 포지션 변화가 주가에 어떤 논리로 영향을 미치는지 (1~2문장. 방향성·논리 위주, % 수치 최소화)

🟢 **Base (핵심 이슈 정상 실현):**
- **실현 조건:** [핵심 이슈가 정상 궤도로 전개되는 조건 1~2문장]
- **사업 전개:** [조건 충족 시 시장 점유율·고객사 관계·경쟁 구도가 어떻게 변화하는지 2~3문장]
- **주가 시사점:** [투자자 심리·밸류에이션 재평가 방향을 방향성 중심으로 1~2문장]

🔵 **Bull (초과 달성):**
- **실현 조건:** [예상을 상회하는 조건 1~2문장]
- **사업 전개:** [초과 달성 시 사업 모멘텀 가속·시장 포지션 변화 2~3문장]
- **주가 시사점:** [멀티플 확장·섹터 리레이팅 가능성 등 1~2문장]

🔴 **Bear (미실현·역풍):**
- **실현 조건:** [이슈가 실패하거나 역풍이 부는 조건 1~2문장]
- **사업 전개:** [사업 전략 타격·경쟁사 대비 포지션 변화 2~3문장]
- **주가 시사점:** [투자 심리 위축·멀티플 하락 압력·리스크 재부각 1~2문장]
