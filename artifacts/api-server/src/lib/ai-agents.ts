...
⛔ 빈 셀 절대 금지 — 모든 셀에 반드시 텍스트를 채워야 합니다. 셀 내 줄바꿈 금지(한 셀 = 한 줄).
- 시점: "단기(~3개월)", "중기(3~12개월)", "장기(1년+)" 중 하나만 사용
- 이벤트/지표: 구체적 날짜·수치 조건 포함 (예: "25년 3Q 일본 품목허가 결과 발표")
- 재무 영향: 매출·영업이익·EPS 예상 변화 수치 (예: "영업이익 +X억", "EPS +X원") — 근거 없으면 "영향 미미" 또는 "추정 불가"
- 의미: "→ 긍정 신호" 또는 "→ 부정 신호" 형식

| 시점 | 이벤트 / 확인 지표 | 재무 영향 | 의미 |
|------|------|------|------|
| 단기(~3개월) | [이벤트 내용] | [재무 영향] | → [긍정/부정] 신호 |
| 단기(~3개월) | [이벤트 내용] | [재무 영향] | → [긍정/부정] 신호 |
| 단기(~3개월) | [이벤트 내용] | [재무 영향] | → [긍정/부정] 신호 |
| 중기(3~12개월) | [이벤트 내용] | [재무 영향] | → [긍정/부정] 신호 |
| 중기(3~12개월) | [이벤트 내용] | [재무 영향] | → [긍정/부정] 신호 |
| 중기(3~12개월) | [이벤트 내용] | [재무 영향] | → [긍정/부정] 신호 |
| 장기(1년+) | [이벤트 내용] | [재무 영향] | → [긍정/부정] 신호 |
| 장기(1년+) | [이벤트 내용] | [재무 영향] | → [긍정/부정] 신호 |
...
⛔ 빈 셀 절대 금지 — 모든 셀을 반드시 채우세요. 셀 내 줄바꿈 금지.
