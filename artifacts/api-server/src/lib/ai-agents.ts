...
**⛔ 재투자 계산 — 단 하나의 공식 (예외 없이 매년 적용):**
    ...
    당해연도 재투자 = MAX(
      ...
      기업별 절대 하한              ← 삼성전자 55조 / SK하이닉스 18조 / TSMC USD 25B
    )

**기업별 절대 하한 (어떤 시나리오에서도 이 밑으로 내려갈 수 없음):**
- 삼성전자(005930): **55조원/year**
- SK하이닉스(000660): **18조원/year**
- TSMC(TSM): **USD 250억/year**

**Cascading Floor 연쇄 적용 예시:**
- 2026년 재투자 = 80조 → 2027년 최솟값 = MAX(S-to-C공식, 80×0.70=56조, 55조) = MAX(공식, **56조**)
- 2027년 재투자 = 56조 → 2028년 최솟값 = MAX(S-to-C공식, 56×0.70=39조, **55조**) = MAX(공식, **55조**)
  → 절대 하한이 Cascading Floor를 넘는 순간 절대 하한이 기준이 됨

⛔ **표 작성 전 자가검증 (필수):**
1. 각 연도별: 전년 대비 재투자 감소율 = (당년 − 전년) ÷ 전년 × 100
2. 감소율이 –30% 초과 → MAX 공식 미적용 → 즉시 수정
3. 삼성전자인데 재투자 < 55조 → 절대 하한 미적용 → 즉시 55조로 교체
