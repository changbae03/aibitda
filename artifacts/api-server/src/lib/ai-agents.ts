...
- "현재가(__원)가 상단 밴드(__원) 상회 — 신규 진입 시 단기 과열 리스크 존재. 보유 중이면 일부 차익 실현 시점 검토 가능."
- 재진입 참고 기준: 상단 밴드 지지 확인 + __원 이상 안착

---

**리스크 관리 기준선 (참고용)**

⚠️ 아래 수치는 투자 권유가 아닌 리스크 시나리오 참고 분석입니다. 실제 판단은 투자자 본인이 결정합니다.

- 1차 하방 지지 구간: __원 ~ __원 (근거: 기술적 지지선 __원 이탈 시나리오)
- 핵심 하방 기준선: __원 (근거: 하단 밴드 __원 / 중요 지지선 __원 중 보수적 값)
- 리스크 재검토 기준: 종가 기준 __원 하회 시 포지션 재검토 시나리오
