...
${companyName}이 속한 산업을 아래 3개 섹션으로 분析하세요.
...
성장 동력(수치 포함, 1~2가지)과 주요 리스크(수치 포함, 1~2가지)를 먼저 제시하고, 이어서 위 표 수치를 뒷받침하는 핵심 가정 2~3가지를 불릿으로 서술하세요. 각 불릿에 수치 근거 포함. 별도 소제목 없이 자연스럽게 연결하세요.
