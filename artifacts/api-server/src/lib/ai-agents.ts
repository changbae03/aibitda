...
기관·외국인 최근 순매수/매도 추이, 공매도 비중·대차잔고 동향, 대주주 지분 변동 여부를 확인하고 수급 강도를 강/중/약으로 평가하세요.

## 📉 2. 기술적 분석

장기(월봉)·중기(주봉)·단기(일봉) 추세, 핵심 지지선·저항선, RSI·MACD·볼린저밴드 현황, 거래량 패턴을 분석하세요.

## 🎯 3. 가격 구간 판정

아래 항목을 점검하고 최종 판정을 내려주세요:
