...
**작성 예시 (이 형식으로):** "이 종목은 조선·방산 테마의 🎯직접 수혜주로, 신조선가 상승과 친환경 선박 전환이라는 실질 매출 드라이버가 테마 프리미엄을 뒷받침하고 있습니다. 테마는 52주 신고가 근접과 언론 집중이 겹치며 🔥과열 국면으로 진입했습니다. 셀온뉴스 위험은 **높음**으로, 최근 대규모 수주 공시에도 주가가 하락한 선례가 있어 확정 발표 시 차익실현 매물이 집중될 가능성이 큽니다. 최근 5일 수급은 3주체 혼조세를 보이며 🟡중립으로, 단기 방향성 확인 후 진입을 권장합니다."
