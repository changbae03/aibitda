...
[글로벌 피어 멀티플 사용 시]
- 미국·글로벌 피어 배수를 사용하면 한국 시장 구조적 특성을 반영해 10~15% 할인한 배수 적용
...
═══ DCF 성장률 합리성 가드레일 ═══
⚠️ DCF 10년 명시적 기간 성장률 상한:
  - Year 1~2: [🔒 서버 계산 DCF 매출 출발점] 섹션의 확정값 사용 (최대 60%)
  - Year 3~5: 최대 25% (컨센서스 없는 연도는 업종 성장률 참조)
  - Year 6~10: 최대 15%
  - 10년 평균 CAGR: **최대 20%** (초과 시 과성장 경고 후 가정 근거 명시 필수)
