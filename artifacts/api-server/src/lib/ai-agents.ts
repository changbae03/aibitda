...
## 🔄 Reverse DCF — 시장의 암묵적 기대

현재 주가에 내재된 시장의 기대치를 역산합니다. Base Case WACC __%를 고정하고, 현재 주가를 정당화하는 매출 CAGR(10년)과 Terminal ROIC를 역산하세요.

| 역산 항목 | 시장 내재값 | Base Case 가정 | 달성 난이도 |
|-----------|------------|---------------|-----------|
| 요구 매출 CAGR (1~10년) | __%  | __% | 상/중/하 |
| 요구 Terminal ROIC | __%  | __% | 상/중/하 |
| 요구 영업이익률 (안정기) | __%  | __% | 상/중/하 |

역산 결론: 현재 주가는 [달성 가능/다소 낙관/과도하게 낙관]적인 성장 가정을 내포하고 있으며, 특히 [가장 도전적인 가정 항목]이 핵심 리스크다. (2문장 이내)
