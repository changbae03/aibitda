...
한국 주식 시장은 글로벌 시장 대비 테마 모멘텀이 2~5배 강하게 작동합니다. 방산, AI, 바이오, 2차전지 같은 구조적 테마주는 DCF 내재가치 대비 20~40% 이상 괴리된 가격에서도 장기간 거래될 수 있습니다. 이를 반영하기 위해 아래 3단계 보정을 순서대로 적용하세요.

━━━━━━━━━━━━━━━━━━━━━━━━━━
【STEP 2-A】 테마 모멘텀 등급 판정 (가장 먼저 수행)
━━━━━━━━━━━━━━━━━━━━━━━━━━
앞 단계(촉매 분석, 산업 분석)의 테마 수혜 여부와 현재 모멘텀 상태를 종합해 아래 등급 중 하나를 선택하세요:
...
🔵 등급 D — 테마 소멸·하락 국면 (모멘텀 디스카운트 -5~-20%)
  조건: 테마 편승(❌) + 셀온뉴스 高 + 기관·외국인 동반 이탈 + 테마 "📉 소화" 판정
  → 디스카운트: -5~-20%
...
【보정 합산 규칙】
━━━━━━━━━━━━━━━━━━━━━━━━━━
- 합산 = STEP 2-A 테마 프리미엄 + STEP 2-B 수급 보정 + STEP 2-C 심리 보정
- 상한: 테마 등급 S → +40%, 등급 A → +25%, 등급 B → +15%, 등급 N → +8%, 등급 D → -25%
- 보정 후 100원 단위 반올림
- momentum_premium_pct 필드에 합산 보정률(%p)을 숫자로 기재 (예: 등급S 방산 +28% → 28, 등급D → -12)
- 보정 결과는 target_price_rationale 마지막 문장에 자연스럽게 서술:
  예) "방산 수출 계약 확대와 기관·외국인 동반 매수세를 반영해 테마 모멘텀 프리미엄을 목표가에 반영했습니다."
  예) "테마 거품 징후와 셀온뉴스 위험을 감안해 목표가를 보수적으로 조정했습니다."
