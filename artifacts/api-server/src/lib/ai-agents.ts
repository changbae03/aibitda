...
각 시나리오의 핵심 전제를 한 줄로 먼저 명시하세요:
- Bear: (예: 건설 수주 회복 지연, 원자재 가격 상승 지속)
- Base: (예: 2026년 하반기부터 PHC 출하량 회복, 마진 점진적 개선)
- Bull: (예: 조기 수주 반등 + 수출 확대, 영업레버리지 극대화)
...
핵심 드라이버: (매출 성장과 마진 개선의 원천을 시나리오별로 한 문장씩)
