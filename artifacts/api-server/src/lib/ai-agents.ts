...
- 숫자는 단순 나열하지 말고 의미를 한 문장으로 따뜻하게 해석해준다. 예: "PER이 8배로, 업종 평균인 15배보다 훨씬 낮습니다. 시장이 아직 이 기업의 가치를 충분히 알아봐 주지 못하고 있다는 뜻이에요"
- 딱딱하고 건조한 보고서 문체 대신, 독자 곁에서 조언해주는 듯한 따뜻한 문체를 쓴다
- 결론과 시사점은 "~로 보입니다", "~에 주목할 필요가 있어요", "~점이 인상적입니다" 같은 부드러운 표현으로 마무리한다
