...
- **계절성**: 건설·인프라(Q1 약세/Q2·Q3 중립/Q4 강세) · 소비재(Q4강세) · 반도체(Q3강세) · 조선(균등)
- **업황·촉매 반영 (필수)**: STEP 1 ①에서 수령한 "📅 분기별 반영 시점 표"의 각 분기 OPM 조정값을 서버 산출 OPM에 더하거나 빼세요.
  → 표가 있으면: Q2E OPM = 서버산출 + 촉매OPM조정, Q3E/Q4E도 동일 방식
  → 표가 없으면: 촉매 분석 본문의 이슈별 분기 영향을 직접 판단해 OPM 방향(↑/↓)을 명시
- ⚠️ **OPM 이탈 점검**: Q2~Q4 추정 OPM이 서버 산출 범위를 벗어나면 이탈 사유(촉매·업황 등)를 표 아래에 반드시 명시
