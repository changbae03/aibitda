  ...
  const THEME_SEED_MAP: Array<{ themeKW: string[]; tickers: [string, string][] }> = [
    {
      ...
      tickers: [
        ...
        ["036690", "코맥스"], ["000720", "현대건설"], ["086280", "현대글로비스"],
      ],
    },
    {
      ...
      tickers: [
        ...
        ["267250", "HD현대"],          // 조선 지주사
        ["100090", "SK오션플랜트"],    // 해양플랜트·해상풍력 설치 전문
        ["077970", "STX엔진"],         // 선박·발전용 엔진 제조
        ["042700", "한미반도체"],      // 수혜 확인용 예비 후보
      ],
    },
    {
    ...
    },
    {
      ...
      tickers: [
        ...
        ["298020", "효성티앤씨"], ["011070", "LG이노텍"], ["004490", "세방전지"],
        ["120110", "코오롱인더"],
      ],
    },
    {
    ...
    },
    {
      ...
      tickers: [
        ...
        ["036540", "SFA반도체"], ["091070", "토비스"],
        ["336370", "솔루스첨단소재"], ["140860", "파크시스템스"],
        ["440710", "에이피티씨"], ["104830", "원익머트리얼즈"],
        ["365340", "성일하이텍"], ["000990", "DB하이텍"],
      ],
    },
    {
      // AI·데이터센터 테마
