...
【keep=true 기준】
1. 해당 테마 관련 제품·서비스·부품을 기업이 직접 생산·납품·개발
2. "[사명] 관련주/협력사" 테마면 → 실제 납품·계약·파트너십 이력이 있는 공급사도 keep=true
3. 지주회사 본체(자회사가 수혜여도 지주 자체는 keep=false)는 제외
4. 업종이 테마와 명백히 불일치 (방산 테마의 순수 바이오/제약사 → keep=false)

【keep=false 기준】
- 업종이 테마와 전혀 무관 (예: 방산 테마의 제약사)
- 지주회사 본체
- 실제 납품·계약 없이 기대감·추측 수준만인 기업
