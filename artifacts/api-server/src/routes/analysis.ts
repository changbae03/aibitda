...
5. 실적 전망 정합성 (실적 전망 단계 전용 필수 검증):
   ...
   - 수익성 분석 표(매출총이익률·영업이익률·EBITDA 마진·ROE·ROIC)가 없으면: 불승인
   - 현금흐름 품질(영업CF·FCF·전환율·FCF 품질 평가)이 없으면: 불승인
   - 재무건전성(부채비율·순현금·이자보상배율)이 없으면: 불승인
   - Base 실적 추정 테이블(매출·영업이익·EBITDA·EPS 수치 포함)이 없으면: 불승인
